...
\newcounter{tmpbctr}\setcounter{tmpbctr}{0}
\loop
\stepcounter{tmpbctr}
...
But maybe that's not my problem. Maybe my problem is once again that I'm defining things in a loop.\citelist{\cite{macronamesloop} \cite{loopmathcal}}
%\the\inteval{tmpchar}
...
%\edef\tmpinput{\the\numexpr \totalpos - 1}
%\def\currentchar{\lucidcharat{\tmpinput}}
