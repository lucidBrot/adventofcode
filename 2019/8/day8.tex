...
\def\layersize{6}
\bigskip\noindent
TODO: set up layersize from input and make sure there is no off-by-one error in the loop condition\\
\def\numlayers{3}
TODO: set up numlayers from input and make sure there is no off-by-one error in the loop condition\\
