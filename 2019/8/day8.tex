...
\newcounter{bestlayerzerocountcounter}\setcounter{bestlayerzerocountcounter}{0}
	...
	% For each character in the current layer
		...
		\IfEq {0}{\currentchar}{
		  ...
		  \ifnum \value{currentlayerzerocounter} > \value{bestlayerzerocountcounter}
			Skipping Layer \thelayercounter~ because it has more zeros (i.e. it is worse than) Layer ~\thebestlayercounter.
TODO: actually skip
		  \fi
		}{ % else
